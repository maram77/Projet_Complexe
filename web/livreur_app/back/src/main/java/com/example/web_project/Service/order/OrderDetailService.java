...
public class OrderDetailService  {
    ...
    public OrderDetailService(RabbitTemplate rabbitTemplate) {
    ...
    public void  SendUpdateOrder(OrderDetail order , String Status) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        System.out.println(Status);
        order.setOrderStatus(Status);
        String queuePayloadString = objectMapper.writeValueAsString(order);
        System.out.println(order.getOrderStatus());
        rabbitTemplate.convertAndSend("statusQueue", queuePayloadString);
